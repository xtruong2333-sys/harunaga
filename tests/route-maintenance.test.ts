...
describe('Bắt Bài Đối Thủ — Giai Đoạn 11: Route Maintenance & Lazy Loading', () => {
  const EXPECTED_ROUTES = [
    ...
    { path: '/bao-cao', name: 'Report', title: 'Báo Cáo — Bắt Bài Đối Thủ' },
    { path: '/video-moi-dang', name: 'NewVideos', title: 'Video Mới Đăng — Bắt Bài Đối Thủ' },
    ...
    { path: '/lich-dang-doi-thu', name: 'PublishingSchedule', title: 'Lịch Đăng Của Đối Thủ — Bắt Bài Đối Thủ' },
    { path: '/lich-su-canh-bao', name: 'AlertHistory', title: 'Lịch Sử Cảnh Báo — Bắt Bài Đối Thủ' },
  ...
  it('Tất cả 15 routes chính đều được đăng ký đầy đủ và không bị mất', () => {
  ...
  it('Tất cả các Page component đều sử dụng lazy loading (dynamic import functions)', async () => {
    ...
    expect(pageRoutes.length).toBe(14);
